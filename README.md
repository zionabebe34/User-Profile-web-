...
## Description
This project number 2 is a homework assignment that fetches user data from a public API and displays it in a clean profile page. The app shows the user's name, avatar, email, bio, and a list of their posts — all rendered dynamically in the browser.
